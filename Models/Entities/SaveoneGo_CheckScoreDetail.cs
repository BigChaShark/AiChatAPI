...
[Table("SaveoneGo_CheckScoreDetail")]
public partial class SaveoneGo_CheckScoreDetail
{
    [Key]
    ...
    [InverseProperty("SaveoneGo_CheckScoreDetails")]
    public virtual SaveoneGo_CheckScore? SaveoneGo_CheckScore { get; set; }
