...
public partial class Member
{
    ...
    public virtual ICollection<SaveoneGoMemberRobinson> SaveoneGoMemberRobinsons { get; set; } = new List<SaveoneGoMemberRobinson>();

    public virtual ICollection<SaveoneGoMember> SaveoneGoMembers { get; set; } = new List<SaveoneGoMember>();
}
